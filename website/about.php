...
?>
					...
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse in">
							<div class="panel-body">
								...
								I'm gothic, I'm mysterious, and there's a lot that goes on in my life that most people don't know about. It was only a month ago when I mentioned in class that I was adopted. And thenthis girl who is part of the bitchy crew, but isn't as bad as most of them says 'Oh, I didn't know', like it would have made a difference. They're the kind of things that infuriate me, people judging people on their appearence, bullying, and comments which divide some people from the rest of the human race. 							</div>
						</div>
					</div>
					<div class="panel panel-default">
						<div class="panel-heading">
	...
	<!-- ends about,mission -->
		...
		<div class="col-md-5  wow fadeInLeft">
			<div class="row">
				<p><h3>the ultimate evolving path</h3></p>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="block-heading-two">
								<h3><span>my Expertise</span></h3>
							</div>
							<h6>Web Development,Graphic</h6>
